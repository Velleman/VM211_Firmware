...
#include <AS3935_I2C_PSImod.h>                  // Specific lib for AS3935 sensor (mod by PSI to choose IRQ pin myself)
#include <SparkFunBME280.h>                     // BME280 library by SparkFun
#include <Wire.h>                               // Wire library
#include <MCUFRIEND_kbv.h>                      // TFT library by David Prentice
...
#include <Fonts/FreeSans9pt7b.h>                // Font FreeSans 9pts (as an alternative for basic font)
