...
uint8_t AS3935_I2C::_sing_reg_read(uint8_t RegAdd)
{
...
void AS3935_I2C::_sing_reg_write(uint8_t RegAdd, uint8_t DataMask, uint8_t RegData)
{
	...
	I2c.write(_devadd, RegAdd, RegData);
	Serial.print("wrt: ");
...
void AS3935_I2C::AS3935_DefInit()
{
	_AS3935_Reset();			// reset registers to default
}

void AS3935_I2C::_AS3935_Reset()
{
...
void AS3935_I2C::AS3935_PowerUp(void)
{
...
void AS3935_I2C::AS3935_PowerDown(void)
{
...
void AS3935_I2C::AS3935_DisturberEn(void)
{
...
void AS3935_I2C::AS3935_DisturberDis(void)
{
	// register 0x03, PWD bit: 5 (sets MASK_DIST)
	_sing_reg_write(0x03, 0x20, 0x20);
}

void AS3935_I2C::AS3935_SetIRQ_Output_Source(uint8_t irq_select)
{
...
void AS3935_I2C::AS3935_SetTuningCaps(uint8_t cap_val)
{
...
uint8_t AS3935_I2C::AS3935_GetInterruptSrc(void)
{
...
uint8_t AS3935_I2C::AS3935_GetLightningDistKm(void)
{
	uint8_t strike_dist = (_sing_reg_read(0x07) & 0x3F);	// read register, get rid of non-distance data
	return strike_dist;
}

uint32_t AS3935_I2C::AS3935_GetStrikeEnergyRaw(void)
{
...
uint8_t AS3935_I2C::AS3935_SetMinStrikes(uint8_t min_strk)
{
...
void AS3935_I2C::AS3935_SetIndoors(void)
{
	...
	Serial.println("Configured used for indoor operation");
}

void AS3935_I2C::AS3935_SetOutdoors(void)
{
	// AFE settings addres 0x00, bits 5:1 (01110, based on datasheet, pg 19, table 15)
	_sing_reg_write(0x00, 0x3E, 0x1C);
	Serial.println("Configured used for outdoor operation");
}

void AS3935_I2C::AS3935_ClearStatistics(void)
{
...
uint8_t AS3935_I2C::AS3935_GetNoiseFloorLvl(void)
{
...
void AS3935_I2C::AS3935_SetNoiseFloorLvl(uint8_t nf_sel)
{
	// NF settings addres 0x01, bits 6:4
	// default setting of 010 at startup (datasheet, table 9)
...
uint8_t AS3935_I2C::AS3935_GetWatchdogThreshold(void)
{
...
void AS3935_I2C::AS3935_SetWatchdogThreshold(uint8_t wdth)
{
...
uint8_t AS3935_I2C::AS3935_GetSpikeRejection(void)
{
...
void AS3935_I2C::AS3935_SetSpikeRejection(uint8_t srej)
{
...
void AS3935_I2C::AS3935_SetLCO_FDIV(uint8_t fdiv)
{
...
void AS3935_I2C::AS3935_PrintAllRegs(void)
{
...
void AS3935_I2C::AS3935_ManualCal(uint8_t capacitance, uint8_t location, uint8_t disturber)
{
